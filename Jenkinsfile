...
//         stage("Git Checkout") {
//             steps {
//                 git branch: 'main', url: 'https://github.com/GunjanRajSingh/Amazon-Devsecops.git'
//             }
//         }
...
//             steps {
//                 script {
//                     env.IMAGE_TAG = "gunjan37raj/amazon:${BUILD_NUMBER}"
...
//                         sh "docker login -u gunjan37raj -p ${dockerpwd}"
//                         sh "docker tag amazon ${env.IMAGE_TAG}"
//                         sh "docker push ${env.IMAGE_TAG}"

//                         // Also push latest
//                         sh "docker tag amazon gunjan37raj/amazon:latest"
//                         sh "docker push gunjan37raj/amazon:latest"
//                     }
//                 }
//             }
//         }
...
//                 """,
//                 to: 'info2rajsingh@gmail.com',
//                 from: 'info2rajsingh@gmail.com',
//                 mimeType: 'text/html',
